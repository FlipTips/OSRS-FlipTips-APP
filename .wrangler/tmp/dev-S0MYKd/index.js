...
<\/script>
    ...
    try {
      if (env2.ASSETS) return env2.ASSETS.fetch(req);
    } catch {
    }
...
// .wrangler/tmp/bundle-n6jBTz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-n6jBTz/middleware-loader.entry.ts
